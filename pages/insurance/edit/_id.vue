  ...
  <main class="user-profile">
    ...
    <div class="card">
        ...
        <div class="card__body">
            ...
            <h4 class="heading-4 mb-sm">Add new insurance</h4>
            ...
            <form class="form form-editable" @keydown="removeError($event.target.name)" @change="removeError($event.target.name)">
                ...
                <div class="form__group">
                    ...
                    <select v-model="package" name="package" class="form__input-control" :class="{'has-error':errors.package}">
                        <option value="0">Select</option>
                ...
                <div class="form__group position--relative">
                    ...
                    <input type="text" name="name" class="form__input-control" placeholder="Enter your insurance name" v-model="name" @keyup="fetchPayerNames" :class="{'has-error':errors.name}">
                ...
                <div class="form__group">
                    ...
                    <select name="title" class="form__input-control" v-model="title">
                        <option value="0">Please select</option>
                ...
                <div class="form__group">
                    ...
                    <input type="text" name="address" class="form__input-control" placeholder="House no, street no, city, state" v-model="address">
                </div>
            ...
            <div class="buttons-group my-sm ml-sm">
              <button class="btn btn--secondary mr-xs less-shadow" @click.prevent="save">Save</button>
              <button class="btn btn--default ml-xs less-shadow">Cancel</button>
            </div>
...
export default {
  ...
  methods: {
    ...
    ...mapActions('insurance', {
      ...
      fetchInsuranceInfo : 'fetchInsuranceInfo'
    }),
    ...
    save() {
     ...
     this.updateInsurance(this.$route.params.id)
     .then(() => {
       this.$toast.success('Insurance updated successfully').goAway(2000);
     })
     .catch(() => {
  ...
  created() {
    ...
    this.fetchTypes();
    this.autoFillAuthInfo({section:'insured', module:'insurance'});
    this.fetchInsuranceInfo(this.$route.params.id);
  }
